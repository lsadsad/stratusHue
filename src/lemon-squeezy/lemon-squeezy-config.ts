...
export const CURRENT_PRICING_MODEL: PricingModel = 'freemium';
...
export const getCurrentPricingConfig = () => PRICING_MODELS[CURRENT_PRICING_MODEL];

// Development vs Production configuration
export const isDevelopment = process.env.NODE_ENV === 'development';

// Use test/sandbox mode in development
export const useSandbox = isDevelopment;