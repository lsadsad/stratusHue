...
**Spec**: `docs/navigate/styledTextFeature.md`
...
**Spec**: `docs/shared/uiSplitRefactor.md`
...
**Spec**: `docs/validate/designLintFeature.md`
...
**Spec**: `docs/scaffold/scaffoldMode.md`
...
| Location | Contents |
|---|---|
| `docs/ (mode-first — navigate/, validate/, scaffold/, shared/) | Feature specs 
...
See `docs/shared/README.md` for the feature index.
