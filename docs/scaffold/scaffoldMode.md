...
## Related Docs
- `docs/validate/designLintFeature.md` — Validate mode (the mirror of Scaffold)
- `docs/navigate/styledTextFeature.md` — Navigate mode, potential Scaffold content seeding integration
