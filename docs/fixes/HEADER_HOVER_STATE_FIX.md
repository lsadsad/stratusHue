...
> Current header action icon color behavior is documented in `docs/features/reference/colorCodedButtons.md` (section-level color-context + theme-specific contrast tuning).
