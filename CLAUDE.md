...
> finePrint shortHand phrases, agent tools, and session conventions are maintained in [groundControl CLAUDE.md](https://github.com/lsadsad/groundControl/blob/main/CLAUDE.md).
